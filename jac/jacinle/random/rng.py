...
from jac.jacinle.utils.defaults import defaults_manager
from jac.jacinle.utils.registry import Registry
...
def gen_seed():
    # return get_default_rng().randint(4294967296) # out of the range int32
    return get_default_rng().randint(2147483648)
