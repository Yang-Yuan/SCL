...
import jac.jacinle.random as random
from jac.jactorch.quickstart.train import ModelTrainer
from jac.jactorch.quickstart.models import LinearClassificationModel, MLPClassificationModel
