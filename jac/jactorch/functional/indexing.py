...
from jac.jacinle.utils.numeric import prod
from jac.jacinle.utils.vendor import has_vendor, requires_vendors
from jac.jactorch.utils.grad import no_grad_func
...
if has_vendor('torch_index'):
    ...
    from jac.jacinle.utils.meta import make_dummy_func
