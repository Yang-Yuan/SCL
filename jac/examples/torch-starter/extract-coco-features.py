...
from jac.jacinle.utils.container import GView
from jac.jacinle.utils.tqdm import tqdm
...
class COCOImageDataset(Dataset):
    ...
    def make_dataloader(self, batch_size, shuffle, drop_last, nr_workers):
        ...
        from jac.jactorch.data.collate import VarLengthCollateV2
...
class FeatureExtractor(nn.Module):
    def __init__(self):
        ...
        import jac.jactorch.models.vision.resnet as resnet
